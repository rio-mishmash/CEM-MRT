...
```{r}
PSM = matrix(c(
  300, 0.100, 297, 0.165, 0.246, 2.390, 0.947, 0.140, 0,
  300, 0.050, 293, 0.161, 0.231, 1.449, 0.928, 0.126, 0,
  300, 0.025, 283, 0.162, 0.221, 1.055, 0.928, 0.097, 0,
  300, 0.020, 278, 0.158, 0.216, 0.999, 0.918, 0.090, 0,
  300, 0.010, 246, 0.136, 0.202, 0.908, 0.936, 0.075, 0,
  300, 0.008, 230, 0.123, 0.194, 0.907, 0.942, 0.071, 0,
  300, 0.005, 190, 0.102, 0.192, 0.949, 0.953, 0.078, 0,
  300, 0.004, 169, 0.087, 0.191, 0.989, 0.962, 0.083, 0
), nrow=8, byrow=TRUE)
...
```{r}
CEM = matrix(c(
  300, 10, 36.9, 0.108, 0.379, 1.81, 0.908, 0.165, 0
), nrow=1, byrow=TRUE)
...
```{r}
CART = matrix(c(
  300, 10, 294, 0.166, 0.228, 1.172, 0.908, 0.143, 0,
  300,  8, 290, 0.161, 0.220, 1.064, 0.911, 0.130, 0,
  300,  6, 280, 0.152, 0.212, 0.959, 0.918, 0.115, 0,
  300,  5, 271, 0.149, 0.210, 0.918, 0.918, 0.107, 0,
  300,  4, 256, 0.138, 0.201, 0.882, 0.931, 0.098, 0,
  300,  3, 231, 0.128, 0.197, 0.851, 0.934, 0.094, 0,
  300,  2, 183, 0.107, 0.197, 0.868, 0.928, 0.091, 0
), nrow=7, byrow=TRUE)
...
```{r}
RF = matrix(c(
  300,  2, 299, 0.312, 0.348, 1.730, 0.780, 0.215, 0,
  300,  3, 286, 0.281, 0.321, 1.136, 0.786, 0.201, 0,
  300,  4, 275, 0.238, 0.284, 1.077, 0.845, 0.198, 0,
  300,  5, 243, 0.170, 0.235, 0.956, 0.879, 0.137, 0,
  300,  6, 234, 0.165, 0.234, 0.951, 0.882, 0.136, 0,
  300,  7, 216, 0.156, 0.228, 0.944, 0.900, 0.129, 0,
  300,  8, 195, 0.145, 0.224, 0.959, 0.917, 0.120, 0,
  300,  9, 184, 0.140, 0.224, 0.967, 0.913, 0.120, 0,
  300, 10, 159, 0.128, 0.232, 1.017, 0.929, 0.120, 0
), nrow=9, byrow=TRUE)
...
```{r}
MRT = matrix(c(
  300, 10, 295, 0.225, 0.277, 1.196, 0.863, 0.169, 0,
  300,  8, 292, 0.215, 0.264, 1.083, 0.855, 0.158, 0,
  300,  6, 284, 0.212, 0.260, 0.990, 0.870, 0.147, 0,
  300,  5, 278, 0.207, 0.256, 0.976, 0.854, 0.141, 0,
  300,  4, 267, 0.195, 0.247, 0.945, 0.879, 0.135, 0,
  300,  3, 249, 0.185, 0.240, 0.906, 0.888, 0.121, 0,
  300,  2, 220, 0.170, 0.235, 0.902, 0.895, 0.123, 0,
  300,  1, 170, 0.155, 0.233, 0.967, 0.911, 0.119, 0
), nrow=8, byrow=TRUE)
