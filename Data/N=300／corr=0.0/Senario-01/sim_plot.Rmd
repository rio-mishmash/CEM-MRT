...
```{r}
PSM = matrix(c(
300, 0.100, 297, 0.163, 0.247, 2.634, 0.966, 0.137, 0,
300, 0.050, 293, 0.155, 0.230, 1.496, 0.935, 0.121, 0,
300, 0.025, 283, 0.158, 0.221, 1.034, 0.914, 0.090, 0,
300, 0.020, 278, 0.154, 0.215, 0.963, 0.910, 0.081, 0,
300, 0.010, 246, 0.137, 0.202, 0.850, 0.917, 0.068, 0,
300, 0.008, 230, 0.124, 0.195, 0.844, 0.925, 0.062, 0,
300, 0.005, 190, 0.102, 0.191, 0.871, 0.928, 0.070, 0,
300, 0.004, 169, 0.089, 0.191, 0.908, 0.949, 0.075, 0
), nrow=8, byrow=TRUE)
...
```{r}
CEM = matrix(c(
300, 10, 36.9, 0.117, 0.381, 1.8, 0.903, 0.161, 0
), nrow=1, byrow=TRUE)
...
```{r}
CART = matrix(c(
300, 10, 294, 0.197, 0.254, 1.156, 0.892, 0.140, 0,
300, 8, 290, 0.191, 0.246, 1.053, 0.890, 0.126, 0,
300, 6, 280, 0.180, 0.235, 0.947, 0.880, 0.105, 0,
300, 5, 271, 0.174, 0.228, 0.908, 0.904, 0.100, 0,
300, 4, 256, 0.164, 0.222, 0.873, 0.893, 0.093, 0,
300, 3, 231, 0.153, 0.216, 0.840, 0.905, 0.091, 0,
300, 2, 183, 0.128, 0.211, 0.855, 0.901, 0.087, 0
), nrow=7, byrow=TRUE)
...
```{r}
RF = matrix(c(
300, 2, 299, 0.349, 0.384, 1.655, 0.743, 0.209, 0,
300, 3, 286, 0.308, 0.346, 1.113, 0.757, 0.195, 0,
300, 4, 275, 0.264, 0.309, 1.058, 0.808, 0.193, 0,
300, 5, 243, 0.195, 0.256, 0.942, 0.860, 0.131, 0,
300, 6, 234, 0.190, 0.254, 0.936, 0.864, 0.129, 0,
300, 7, 216, 0.183, 0.249, 0.932, 0.879, 0.125, 0,
300, 8, 195, 0.169, 0.242, 0.949, 0.901, 0.119, 0,
300, 9, 184, 0.163, 0.240, 0.958, 0.909, 0.118, 0,
300, 10, 159, 0.149, 0.244, 1.000, 0.901, 0.118, 0
), nrow=9, byrow=TRUE)
...
```{r}
MRT = matrix(c(
300, 10, 295, 0.258, 0.306, 1.176, 0.836, 0.161, 0,
300, 8, 292, 0.248, 0.293, 1.064, 0.819, 0.151, 0,
300, 6, 284, 0.244, 0.287, 0.983, 0.822, 0.142, 0,
300, 5, 278, 0.236, 0.279, 0.963, 0.820, 0.135, 0,
300, 4, 267, 0.225, 0.273, 0.932, 0.838, 0.126, 0,
300, 3, 249, 0.214, 0.265, 0.894, 0.843, 0.115, 0,
300, 2, 220, 0.200, 0.256, 0.898, 0.868, 0.115, 0,
300, 1, 170, 0.181, 0.251, 0.961, 0.899, 0.113, 0
), nrow=8, byrow=TRUE)
